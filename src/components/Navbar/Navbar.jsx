...
import "./navbar.css";
import NavBrandIcon from "../Icons/NavBrandIcon";
    ...
    <header className="header">
      <nav className="nav container">
        <Link to="/" className="nav-logo">
          <NavBrandIcon className="nav-logo" />
        ...
        <div className={isMenuOpen ? "nav-menu show-menu" : "nav-menu"}>
          <ul className="nav-list">
            ...
            <li className="nav-item">
              <Link to="/advice-page" className="nav-link" smooth="true" duration={200} onClick={() => { handleMenuClose(); }}>
            ...
            <li className="nav-item">
              <Link to="/check-pets-page" className="nav-link check-link" onClick={() => { handleMenuClose(); }}>
